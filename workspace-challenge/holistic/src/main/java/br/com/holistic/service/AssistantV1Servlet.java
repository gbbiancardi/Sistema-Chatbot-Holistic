...
/**
 * Classe Responsavel por fazer a comunicacao com o IBM Watson Assistant
...
public class AssistantV1Servlet extends HttpServlet {
	...
	/**
	 * Este metodo envia uma requisicao POST para a API do IBM Watson Assistant
	...
	/**
	 * Este metodo credencia a conexao com o IBM Watson Assistant
	 * @param String msg
